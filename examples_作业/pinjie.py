...
if __name__ == '__main__':
    ...
    # 获取检测到关键特征点后的图像的相关参数
    keypoints_image_right, keypoints_right, features_right = sift_keypoints_detect(imb)
    keypoints_image_left, keypoints_left, features_left = sift_keypoints_detect(ima)
    ...
    # 把图片拼接成全景图并保存
    Panorama = Panorama_stitching(imb, ima)
